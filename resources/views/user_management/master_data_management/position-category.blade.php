...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <h4 class="text-center">Position Category</h4>
            </div>
        </div>
    </div>
    <div class="col-lg-12">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="categoryName" placeholder="Enter Your Category Name">
                            </div>
                        </div>
                        <div class="form-group row">
    ...
    <div class="modal fade" id="formmodaledit">
        <div class="modal-dialog modal-lg">
            <div class="modal-content animated fadeInUp">
                ...
                <div class="modal-body">
                    <form>
                    <input type="hidden" id="idCategoryEdit" class="form-control">
                        <div class="form-group row">
                            <label for="input-21" class="col-sm-2 col-form-label">CATEGORY NAME</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="categoryNameEdit" placeholder="Enter Your Category Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="input-21" class="col-sm-2 col-form-label">DESCRIPTION</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" id="categoryDescEdit"></textarea>
                            </div>
                        </div>
                    </form>
                    <div class="form-group float-right">
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on('click', '.edit-btn', function() {
            ...
            $.ajax({
                ...
                $('#categoryNameEdit').val(datob[0].CategoryName);
                $('#categoryDescEdit').val(datob[0].CategoryDesc);
                $('#idCategoryEdit').val(datob[0].id);
        ...
        $('#btn-submit-add').click(function(e) {
            ...
            $.ajax({
                ...
                $('#example').DataTable().ajax.reload();
                if (datob != 'error') {
                    successAlert('Add', $('#categoryName').val(), 'success');
                } else {
                    errorAlert('Add', $('#categoryName').val(), 'error');
                }
                $('#formmodal').modal('toggle');
            });
