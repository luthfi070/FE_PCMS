                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea name="commentPayment" id="commentPayment" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <label for="input-23" class="col-sm-12 col-form-label">PAA</label>
                            <input type="text" class="form-control" id="totalPAA_non_vat" name="totalPAA_non_vat" value="0" readonly>
                            <input type="hidden" class="form-control" id="totalPAA_non_vat_hide" name="totalPAA_non_vat_hide" readonly>
                        </div>
                        <div class="col-lg-3">
                            <label for="input-23" class="col-sm-12 col-form-label">TA</label>
                            <input type="text" class="form-control" id="totalTA_non_vat" name="totalTA_non_vat" value="0" readonly>
                            <input type="hidden" class="form-control" id="totalTA_non_vat_hide" name="totalTA_non_vat_hide" readonly>
                        </div>
                        <div class="col-lg-3">
                            <label for="input-23" class="col-sm-12 col-form-label">CA</label>
                            <input type="text" class="form-control" id="totalCA_non_vat" name="totalCA_non_vat" value="0" readonly>
            ...
            <div class="card-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <label for="input-23" class="col-sm-12 col-form-label">PAA</label>
                            <input type="text" class="form-control" id="totalPAA_vat" name="totalPAA_vat" value="0" readonly>
                        </div>
                        <div class="col-lg-3">
                            <label for="input-23" class="col-sm-12 col-form-label">TA</label>
                            <input type="text" class="form-control" id="totalTA_vat" name="totalTA_vat" value="0" readonly>
                        </div>
                        <div class="col-lg-3">
                            <label for="input-23" class="col-sm-12 col-form-label">CA</label>
                            <input type="text" class="form-control" id="totalCA_vat" name="totalCA_vat" value="0" readonly>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#btn-save-non-vat').click(function(e) {
            ...
            table2.row.add([
                idx1,
                $('#deductionName').val()+" ( "+$('#deductionValue').val()+"% )",
        ...
        $('#btn-save-payment').click(function(e) {
            ...
            $.ajax({
                ...
                url: '/addPayment',
                method: "POST",
                data: $('#form-title').serialize() + "&_token=" + '{{ csrf_token() }}' + "&docID="+<?php echo $docID;?>+"&deduction=" + JSON.stringify(arr_non_vat) + "&vat=" + JSON.stringify(arr_vat),
                dataType: 'JSON'
            }).done(function(response) {
